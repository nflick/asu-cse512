...
public class SpatialJoinQuery2 implements Serializable {

	private static final long serialVersionUID = 1L;

	private static Broadcast<List<Rectangle>> bv;
	...
	public static void joinQuery(JavaSparkContext context, String input1,
		...
		bv = context.broadcast(rectB.collect());
	...
	public final static Function<Rectangle, Tuple2<Integer, ArrayList<Integer>>> MAPP_CARTESIAN = new Function<Rectangle, Tuple2<Integer, ArrayList<Integer>>>() {
